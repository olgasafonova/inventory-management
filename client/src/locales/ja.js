export default {
  ...
  restocking: {
    title: '補充',
    description: '予算を設定し、その範囲内で需要予測に基づいて補充します',
    budgetLabel: '利用可能な予算',
    recommendedItems: '推奨品目',
    itemsFit: '{total}件中{fit}件が予算内',
    totalCost: '合計費用',
    remainingBudget: '残りの予算',
    placeOrder: '注文する',
    orderSubmitted: '補充注文 {orderNumber} を送信しました。',
    viewInOrders: '注文で表示',
    internalCustomer: '社内補充',
    noItems: '現在、補充が必要な品目はありません。',
    budgetTooLow: '予算が低すぎて補充できる品目がありません。予算を増やしてください。',
    daysCount: '{count}日',
    table: {
      sku: 'SKU',
      itemName: '品目名',
